...
const TextArray translations::Translations =
{
	...
	},
	{
		Msg::KEYMAPPER_Help1,
		{
			{ Lang::Arabic, "لتغيير عناصر التحكم باللعبة، حدد خيارات عناصر التحكم التي تريدها ثم انقر فوق أزرار الأسهم لتغيير مفاتيح محددة ثم اختر \"موافق\"" },
			...
			{ Lang::German, "Wählen Sie die gewünschten Optionen zum Ändern der Bedienelemente, und klicken Sie auf die Pfeile, um die Tastenbelegung zu ändern. Klicken Sie auf \"OK\"" },
			{ Lang::Greek, "Για να αλλάξετε τα πλήκτρα ελέγχου, επιλέξτε το στοιχείο που θέλετε, χρησιμοποιήστε τα πλήκτρα βέλους για να αλλάξετε τα πλήκτρα και μετά επιλέξτε \"OK\"" },
	...
	},
	{
		Msg::KEYMAPPER_Help2,
		{
			{ Lang::Arabic, "لاستعادة ‎3D Pinball إلى الإعدادات الأصلية، اختر \"الافتراضي\" ثم اختر \"موافق\". لاستخدام مفاتيح الأسهم الموجودة في لوحة المفاتيح الرقمية، تأكد أن NUMLOCK مغلق" },
			...
			{ Lang::German, "Klicken Sie auf \"Standard\" und auf \"OK\", um die ursprünglichen Einstellungen von 3D-Pinball wiederherzustellen. Stellen Sie sicher, dass die Num-Taste ausgeschaltet ist, um mit den Pfeiltasten der Zehnertastatur arbeiten zu können." },
			{ Lang::Greek, "Γι α να επαναφέρετε τις αρχικές ρυθμίσεις του Φλίπερ- 3Δ, επιλέξτε \"Προεπιλογή\" και μετά πατήστε \"ΟΚ\". Για να χρησιμοποιήσετε τα πλήκτρα βέλους του αριθμητικού πληκτρολογίου, βεβαιωθείτε ότι το NUMLOCK είναι ανενεργό." },
			...
			{ Lang::Russian, "Для сброса значений клавиш управления по умолчанию нажмите кнопку \"По умолчанию\", а затем кнопку OK." },
			...
			{ Lang::Turkish, "\"3D Pinball\" ın özgün ayarlarını uygulamak için Varsayılan'ı seçip Tamam'ı tıklatın. Sayısal tuş takımındaki tuşları kullanmak için NUMLOCK'un kapalı olması gerekir." },
